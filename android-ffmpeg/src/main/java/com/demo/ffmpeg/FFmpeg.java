...
public class FFmpeg {
    ...
    public FFtask medaiMux(String videoPath, String audioPath, String outputPath, FFcommandExecuteResponseHandler handler) {
        ...
        return FFmpeg.getInstance(null).execute(cmds.toArray(new String[cmds.size()]), handler);
    }
    ...
    private FFtask execute(Map<String, String> environvenmentVars, String[] cmd, FFcommandExecuteResponseHandler ffmpegExecuteResponseHandler) {
        if (cmd.length != 0) {
