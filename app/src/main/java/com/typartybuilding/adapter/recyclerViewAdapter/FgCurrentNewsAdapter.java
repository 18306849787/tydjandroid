...
public class FgCurrentNewsAdapter extends RecyclerView.Adapter {
    ...
    public FgCurrentNewsAdapter(List<ArticleBanner> bannerList, Context mContext) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == TYPE_ITEM_FOOTER){
            ...
            switch (viewType) {
                case VIEW_TYPE_ONE:
                    viewHolder = new ViewHolderOne(inflater.inflate(R.layout.item_recyclerview_fg_current_new1, viewGroup, false));
                    break;
                case VIEW_TYPE_TWO:
                    viewHolder = new ViewHolderTwo(inflater.inflate(R.layout.item_recyclerview_fg_current_new2, viewGroup, false));
                    break;
                case VIEW_TYPE_THREE:
                    viewHolder = new ViewHolderThree(inflater.inflate(R.layout.item_recyclerview_fg_current_new3, viewGroup, false));
                    break;
            }
            return viewHolder;
        }
