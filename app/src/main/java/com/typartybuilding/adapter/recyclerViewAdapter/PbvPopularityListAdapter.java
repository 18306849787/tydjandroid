...
public class PbvPopularityListAdapter extends RecyclerView.Adapter<PbvPopularityListAdapter.ViewHolder>{
    ...
    public PbvPopularityListAdapter(List<PopularityListData.PopularityData> dataList, Context mContex) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate( R.layout.item_recyclerview_popularity_list_pbv,
                viewGroup,false);
