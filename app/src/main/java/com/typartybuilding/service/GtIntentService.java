...
import com.typartybuilding.utils.GtPushMsgUtil;
...
public class GtIntentService extends GTIntentService {
    ...
    public void onReceiveClientId(Context context, String clientid) {
        ...
        MyApplication.editor.putString(MyApplication.prefKey6_GT_clientId,clientid);
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        ...
        if (payload == null) {
            ...
            GtPushMsgUtil.handleTransmission(data,MyApplication.getContext());
           /* // 测试消息为了观察数据变化
    ...
    public void onNotificationMessageClicked(Context context, GTNotificationMessage gtNotificationMessage) {
        ...
        Intent intentAc = new Intent(this, HomeActivity.class);
        startActivity(intentAc);
        Log.i(TAG, "onNotificationMessageClicked: content : " + gtNotificationMessage.getContent());
        Log.i(TAG, "onNotificationMessageClicked: title : " + gtNotificationMessage.getTitle());
