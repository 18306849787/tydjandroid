...
import com.typartybuilding.adapter.recyclerViewAdapter.ChoicenessAdapter1;
 ...
 *  精选 页面
 */
public class HomeFragmentChoicenessNew1 extends BaseFragmentHome {
    ...
    private ChoicenessAdapter1 adapter;
    ...
    private boolean isFirst;       //是否 是 第一次加载数据，需添加轮播图
    ...
    public int getLayoutId() {
        return R.layout.home_fragment_choiceness_new1;
    }
    ...
    public void loadFragment(int id){
        ...
        transaction.replace(id,fgPicture);
        transaction.commit();
        //获取轮播图数据
        getChoicenessData();
    }
    ...
    private void initRecyclerView(){
        ...
        adapter = new ChoicenessAdapter1(dataList,getActivity(),this);
