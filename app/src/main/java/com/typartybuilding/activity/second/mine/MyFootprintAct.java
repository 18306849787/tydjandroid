 ...
 * @describe
 */
@Route(path = MyFootprintAct.PATH)
public class MyFootprintAct extends BaseListAct {
    public static final String PATH = "/act/footprint";
    ...
    public void initData() {
        ...
        mMycollectAdapter.setOnItemLongClickListener(new BaseQuickAdapter.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(BaseQuickAdapter adapter, View view, int position) {
                MixtureData mixtureData = (MixtureData) adapter.getData().get(position);
                delArticle(position,mixtureData.hisId);
                return false;
            }
        });
    ...
    private void initPopupWindow(){
        ...
        textTitle.setText("删除足迹");
        text.setText("确认删除这条足迹吗？");
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                Utils.backgroundAlpha(MyFootprintAct.this,1f);
            }
        });
     ...
     * @param hisId
     */
    public void delArticle(int position,int hisId){
        if (!popupWindow.isShowing()){
                ...
                .subscribe(new Observer<GeneralMixtureData>() {
                    ...
                    public void onNext(GeneralMixtureData generalMixtureData) {
                        ...
                        if (code == 0){
                            ...
                            RetrofitUtil.tokenLose(MyFootprintAct.this,generalMixtureData.message);
                        }
                    }
