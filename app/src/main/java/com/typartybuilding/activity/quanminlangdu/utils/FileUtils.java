...
public class FileUtils {
    ...
    public  static String rootPath="audio_read";
    //原始文件(不能播放)
    private final static String AUDIO_PCM_BASEPATH = "/"+rootPath+"/pcm/";
    //可播放的高质量音频文件
    private final static String AUDIO_WAV_BASEPATH = "/"+rootPath+"/wav/";

    private final static String ALL_AUDIO_FILE = "/"+rootPath+"/audio/";

    private final static String ALL_MP3_FILE = "/"+rootPath+"/audio/";
    ...
    public static void setMp3(){
        ...
        if (isSdcardExit()) {
            ...
            String fileBasePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/"+rootPath+"/mp3/";
    ...
    public static String getMP3FileAbsolutePath(String fileName){
        ...
        if (isSdcardExit()) {
            ...
            String fileBasePath = Environment.getExternalStorageDirectory().getAbsolutePath() + ALL_MP3_FILE;
            File file = new File(fileBasePath);
            //创建目录
            if (!file.exists()) {
                file.mkdirs();
    ...
    public static String getAllAudioFilePath(String fileName){
        if(fileName==null){
        ...
        if (isSdcardExit()) {
            ...
            String fileBasePath = Environment.getExternalStorageDirectory().getAbsolutePath() + ALL_AUDIO_FILE;
            File file = new File(fileBasePath);
            //创建目录
            if (!file.exists()) {
                file.mkdirs();
