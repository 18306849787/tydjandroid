...
package com.typartybuilding.activity.quanminlangdu.wavelibrary.view;
...
import com.typartybuilding.activity.quanminlangdu.wavelibrary.utils.SoundFile;
...
//     	        canvas.drawCircle(i*getMeasuredWidth()/maxPos(), getMeasuredHeight()-line_offset/4, line_offset/4, circlePaint);// 下圆
                circlePaint.setStrokeWidth(4);
     	        canvas.drawLine(i*getMeasuredWidth()/maxPos(), 0+line_offset/2, i*getMeasuredWidth()/maxPos(), getMeasuredHeight()-line_offset/2, circlePaint);//垂直的线
            	//画正在播放的线
