...
public class EducationalBaseActivity extends RedTitleBaseActivity {

    private String TAG = "EducationalBaseActivity";
  ...
  /*  private double latx = 39.9037448095;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_educational_base);
    ...
    private void initPopupWindow(){
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                Utils.backgroundAlpha(EducationalBaseActivity.this,1f);
            }
        });
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (MapUtil.isGdMapInstalled()){
                    MapUtil.openGaoDeNavi(EducationalBaseActivity.this, 0, 0, null,
                            agencyData.orgLatitude, agencyData.orgLongitude, agencyData.orgAddress);
                }else {
                    Toast.makeText(EducationalBaseActivity.this, "尚未安装高德地图", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
