...
public class PlayAudioMixActivityNew extends BaseActivity {

    private String TAG = "PlayAudioMixActivityNew";
   ...
   /* @BindView(R.id.textView_name)
    ...
    private MixtureData microVideo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        microVideo = MyApplication.mixtureData;
        //设置标题栏
        if (microVideo != null ){
    ...
    private void initView(){
        if (microVideo != null) {
            ...
            //点赞数
            textLike.setText(Utils.formatPlayTimes2(microVideo.praisedNum));

            //设置音频标题
            textHeadLine.setText(microVideo.targetTitle);
            ...
            RetrofitUtil.browseMicro(microVideo.targetId);
        }
    }
    ...
    public void onClickShare(){
        ...
        if (userType == 1 || userType == 2) {
            String targetTitle = microVideo.targetTitle;
            if (targetTitle == null || targetTitle == ""){
                targetTitle = getResources().getString(R.string.mic_defaul_title);
            }
            JshareUtil.showBroadView(this,targetTitle,"",microVideo.fileUrl,
                    2,microVideo.targetId);
            ...
            if (microVideo != null) {
                ...
                if (textLike.isSelected()) {
                    ...
                    if (microVideo.isPraise == 0) {
                        //点赞数减1,以前点过赞
                        textLike.setText(Utils.formatPlayTimes2(microVideo.praisedNum));
                        RetrofitUtil.cancelPraise(microVideo.targetId, microVideo.userId);
                    } else {
                        textLike.setText(Utils.formatPlayTimes2(microVideo.praisedNum - 1));
                        RetrofitUtil.cancelPraise(microVideo.targetId, microVideo.userId);
                    }
                    microVideo.isPraise = 0;
                    microVideo.praisedNum += -1;
                    ...
                    if (microVideo.isPraise == 1) {
                        textLike.setText(Utils.formatPlayTimes2(microVideo.praisedNum));
                        RetrofitUtil.microPraise(microVideo.targetId, microVideo.userId);
                    } else {
                        //点赞数加1
                        textLike.setText(Utils.formatPlayTimes2(microVideo.praisedNum + 1));
                        RetrofitUtil.microPraise(microVideo.targetId, microVideo.userId);
    ...
    private void startPlayAudio(){
        ...
        try {
            Log.i(TAG, "startPlayAudio: visionFileUrl : " + microVideo.fileUrl);
            mediaPlayer.reset();
            mediaPlayer.setDataSource(microVideo.fileUrl);
