...
/**
 *  用于播放 混合 数据中的 普通视频， 传递过来的是  MixtureData对象
 */
public class PlayVideoDetailMixActivity extends BaseActivity {

    private String TAG = "PlayVideoDetailMixActivity";
    ...
    private MixtureData mixtureData;    //上一个activity传递的视频数据
    ...
    private void initView(){
        if (mixtureData != null) {
            //加载图片
            String imgUrl = mixtureData.videoCover;

            Glide.with(this).load(imgUrl)
                    .apply(MyApplication.requestOptions)  //url为空或异常显示默认头像
                    .into(imageView);
            headLine.setText(mixtureData.targetTitle);
            playTimes.setText(Utils.formatPlayTimes(mixtureData.browseTimes) + "次播放");
            textDate.setText(Utils.formatDate(mixtureData.publishDate));
            videoAbstract.setText(mixtureData.articleProfile);
            //全屏时的标题
            lcHeadLine.setText(mixtureData.targetTitle);
            //判断是否收藏
    ...
    private void setExoplayer(){
        //设置exoplayer
        exoplayerUtil.setVideoUrl(mixtureData.fileUrl);
        //设置进度条
        setSeekBar();
...
//            }
    ...
    //根据视频尺寸，重新设置 视频控件 的宽高；竖屏时设置，横屏屏时，全屏播放
    ...
    public void onClickShare(){
        ...
        if (userType == 1 || userType == 2) {
            ...
            JshareUtil.showBroadView(this,mixtureData.targetTitle,mixtureData.articleProfile,mixtureData.fileUrl,
    ...
    public void onCollect(){
        ...
        if (userType == 1 || userType == 2) {
            ...
            if (btnCollect.isSelected()) {
                ...
                int code = RetrofitUtil.delCollect(mixtureData.targetId);
             ...
             //收藏
                ...
                btnCollect.setSelected(true);
                int code = RetrofitUtil.addCollect(mixtureData.targetId);
                ...
                .subscribe(new Observer<RecommendData>() {
                    ...
                    public void onNext(RecommendData recommendData) {
                        ...
                        if (code == 0){
                            ...
                            RetrofitUtil.tokenLose(PlayVideoDetailMixActivity.this,recommendData.message);
                        }
