...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    ...
    //旧账号
  /*  public static String apiKey = "3uVh1NN5m3qGayScakC7fFTE";
    public static String secretKey = "P1YSLY6rRhA6R28E2f7tgYhpEmzunOQq";
    public static String licenseID = "sxty2019-face-android";
    public static String licenseFileName = "idl-license.face-android";*/

    //新账号
    public static String apiKey = "tPXgHBh1DworQpbxU5RPSo9R";
    public static String secretKey = "tB4sXMelGYVrsDK0xfpuigzUqHwM17LL";
    public static String licenseID = "sxtydj2019-face-android";
    public static String licenseFileName = "idl-license.face-android";
    /*
     * <p>
