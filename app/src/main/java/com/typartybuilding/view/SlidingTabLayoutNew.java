 ...
 * @describe
 */
public class SlidingTabLayoutNew extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public SlidingTabLayoutNew(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabLayoutNew(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            public void onClick(View v) {
                ...
                if (position != -1) {
                    if (mViewPager.getCurrentItem() != position) {
                        if (UserUtils.getIns().isTourist()&&(position==4||position==5||position==6)){
