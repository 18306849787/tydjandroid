...
# Bean类不能混淆
-keep public class com.typartybuilding.bean.**{*;}
-keep public class com.typartybuilding.gsondata.**{*;}

#全名朗读
-keep class com.typartybuilding.activity.quanminlangdu.**{*;}
...
# 高德地图
#-libraryjars   libs/AMap3DMap_6.8.0_AMapSearch_6.5.0_AMapLocation_4.6.0_20190423.jar
